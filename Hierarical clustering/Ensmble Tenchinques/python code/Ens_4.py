...
df = pd.read_excel("C:/Users/HAI/Desktop/360DigitMG/Assingment/Ensamble Technique/Datasets_ET/Ensemble_Password_Strength.xlsx")
...
predictors = df.loc[:, df.columns!="characters_strength"]
type(predictors)
